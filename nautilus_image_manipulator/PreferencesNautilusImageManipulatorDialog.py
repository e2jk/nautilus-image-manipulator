...
class PreferencesNautilusImageManipulatorDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesNautilusImageManipulatorDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesNautilusImageManipulatorDialog object.
        """
        builder = get_builder('PreferencesNautilusImageManipulatorDialog')
        new_object = builder.get_object("preferences_nautilus_image_manipulator_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesNautilusImageManipulatorDialog object with it in order to
        finish initializing the start of the new PerferencesNautilusImageManipulatorDialog
        instance.
        ...
        self._db_name = "nautilus-image-manipulator"
        ...
        self._record_type = (
            "http://wiki.ubuntu.com/Quickly/RecordTypes/NautilusImageManipulator/"
            "Preferences")
        self._preferences = self.get_preferences()
        # TODO: code for other initialization actions should be added here

    def get_preferences(self):
        """Return a dict of preferences for nautilus-image-manipulator.
...
if __name__ == "__main__":
    dialog = PreferencesNautilusImageManipulatorDialog()
    dialog.show()
    gtk.main()
